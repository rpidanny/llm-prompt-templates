...
export const QuestionWithReasoning: ITemplate = {
...
export const QuestionWithContext: ITemplate = {
...
export const ZeroShotCoT: ITemplate = {
  name: 'Zero Shot CoT',
...
export const ZeroShotCoTAPE: ITemplate = {
  name: 'Zero Shot CoT (APE)',
  description: `CoT prompt discovered by automatic prompt engineer (APE) which is better than the human engineered zero-shot CoT prompt.`,
  tags: ['chain-of-thought', 'reasoning', 'automatic-prompt-engineer'],
...
export const GeneralKnowledge: ITemplate = {
